    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom border-primary">
              <div class="container-fluid">
                <a class="navbar-brand pb-3 pt-2" href="index.html">
                    ...
                    <img id="navbar-logo" src="images/paw.svg" alt="paw icon" width="24" height="24" class="d-inline-block align-text-top">
                    &nbsp; PetPals
                </a>
        ...
        <div id="outer-wrapper" class="p-5 m-5 rounded bg-white rounded">
            <div class="container-fluid py-2">
                <div class="row">
                    <div class="col-12">
                        <h1 class="fs-2 text-center p-4 rounded border" style="background-color: rgb(250, 235, 215);"><?= $user["username"] ?>'s Calendar</h1>
                    </div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-12 col-lg-4 align-items-center">
                        ...
                        <div class="card mt-3" style="width: 18rem;">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">Example Event #1<span class="badge bg-primary" style="float: right;">Mar 1</span></li>

                                <li class="list-group-item">Example Event #2<span class="badge bg-primary" style="float: right;">Apr 12</span></li>

                            </ul>
                          </div>
                    </div>
                    <!-- Begin calendar app -->
                    <div class="col-12 col-md-12 col-lg-8"> <!-- Responsive bootstrap columns -->
                        <div id="cal-app-wrapper" class="rounded p-5 mt-3 border"> <!-- wrapper for inner calendar -->
                            <div id="outer-calendar" class="bg-white p-3 col-12 border border-primary rounded"> <!-- to provide white background to create beige border -->
                                <div id="month" class="border">
                                    <i class="bi bi-arrow-left-circle back fs-2 px-4"></i> <!-- Bootstrap icons for back and next -->
                                    <div id="date">
                                        <h1 class="fs-3 text-center"></h1> <!-- calendar.js loads the month here -->
                                        <p class="fs-4 text-center"></p> <!-- calendar.js loads the full date here (until below 600px) -->
                                        <p id="only-year" class="text-center"></p>  <!-- calendar.js loads year here (until greater than 600px) -->
                                    </div>
        ...
        <div class="row" style="margin: 0px;">
            <div class="col-12 bg-light mt-4">
                <footer class="d-flex flex-wrap justify-content-between align-items-center p-3 my-4 mx-4 border-top border-bottom">
                    <p class="col-md-4 mb-0 text-muted">&copy; 2022 PetPals, Inc</p>

                    <a id="bottom-logo" href="#calendar-index" class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                    ...
                    <ul class="nav col-md-4 justify-content-end" id="fadeshow">
                        ...
                        <li class="nav-item"><a href="?command=login" class="nav-link px-2 text-muted">Login</a></li>
                        <li class="nav-item">
                          <a
                            href="#"
